...
//
//@Deprecated
//public class CashGamePerformanceRepositoryDatastoreOld implements CashGamePerformanceRepository
//{
//    // public static final CashGamePerformanceRepositoryDatastoreOld INSTANCE = new CashGamePerformanceRepositoryDatastoreOld();
//
//    private static final Logger LOGGER = Logger.getLogger(CashGamePerformanceRepositoryDatastoreOld.class.getName());
//
...
//    }
//
//    private CashGamePerformanceRepositoryDatastoreOld()
//    {
...
//
//        Entity playerEnt = playerRepo.getDatastoreEntityFromFilter(performance.getPlayer().getPlayerName());
